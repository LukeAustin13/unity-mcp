...
**MCP for Unity** is a bridge that lets AI assistants (Codex, Cursor, Windsurf, etc.) control the Unity Editor through the Model Context Protocol (MCP). It enables AI-driven game development workflows - creating GameObjects, editing scripts, managing assets, running tests, and more.
...
4. Test on Windows and Mac if possible, and multiple clients (Codex Desktop and Codex are tricky for configuration as of this writing)
