...
After the script compiles (`refresh_unity` + `read_console`), create the asset:

```python
manage_asset(
    action="create",
    asset_type="ScriptableObject",
    script_class="Project.UI.DesignTokens",
    path="Assets/UI/DesignSystem/DesignTokens.asset"
)
```
