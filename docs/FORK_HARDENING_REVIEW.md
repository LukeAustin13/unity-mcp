...
Waves 2–3 include C# that needs a live Unity Editor to verify end-to-end (Python tests cover plumbing/paging/classification; independent code review confirmed the C# compiles and is logic-clean); they ship with EditMode tests under `TestProjects/UnityMCPTests`.
